...
<body>
				...
				<div id="form">
					<form action="admin-templates/" method="post">
						<fieldset>
							...
							<input type="text" id="username" name="username" class="username" value="dreamdu" /> 
							<label for="pass">密码:</label>
							<input type="password" id="pass" name="pass" class="username"/>
						</fieldset>
						<fieldset>
							<legend>性别:</legend>
	...
	<script language="javascript">
		...
		$(".username").blur(function(){
			...
			alert(value+","+count+","+allowedRequest);
		});
	</script>
</body>
</html>