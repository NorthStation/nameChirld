		...
		<div id="topDiv">
			<div id="tmenu">
				<ul>
					...
					<li><a href="/nameChirld/manager/addName_creating">新增(名)字</a></li>
				...
				<div id="form">
					<form action="admin-templates/" method="post">
						...
						<fieldset style="height: 70%;">
							...
							&nbsp;&nbsp;&nbsp;
							<c:forEach items="${ nameChsList }" var="nameCh">
								<select
								size="16" multiple="multiple" id="multipleselect"
								name="multipleselect">
								<option>${nameCh.structure}</option>
								<option>${nameCh.charId }</option>
								<option>JAVASCRIPT</option>
								<option>XML</option>
								<option>PHP</option>
								<option>C#</option>
